    ...
    return (
        <Grid container alignItems="center"  sx={{ bgcolor: '#FFFFFF', width: '100vw', height: '100vh'}}>
            <Stack item xs={12} margin = {1} spacing={10}>
                <Box align='center'>
                ...
                <Typography variant="h4" align='center'>
                    Your Gateway to Seamless Energy Interoperability
                </Typography>
                <Grid item xs={12}>
                    <Stack direction="row" justifyContent="center" sx={{ bgcolor: '#ffffff', width: '100%' }} spacing={5}>
                        <Button variant="contained" href="/accounts/signup">Sign Up</Button>
                        <Button variant="contained" href="/accounts/login">Sign In</Button>
                    </Stack>
                </Grid>
            </Stack>
        </Grid>
